...
-- 3. INDEX ET CLES PRIMAIRES
ALTER TABLE `categories` ADD PRIMARY KEY (`id`);
ALTER TABLE `commentaires` ADD PRIMARY KEY (`id`), ADD KEY `fk_comment_reclamation` (`reclamation_id`), ADD KEY `fk_comment_user` (`user_id`);
ALTER TABLE `gestionnaires` ADD PRIMARY KEY (`id`), ADD KEY `fk_gestionnaires_user` (`user_id`), ADD KEY `fk_gestionnaires_categorie` (`categorie_id`);
ALTER TABLE `pieces_jointes` ADD PRIMARY KEY (`id`), ADD KEY `fk_pj_reclamation` (`reclamation_id`);
ALTER TABLE `reclamations` ADD PRIMARY KEY (`id`), ADD KEY `fk_reclamations_user` (`user_id`), ADD KEY `fk_reclamations_categorie` (`categorie_id`), ADD KEY `fk_reclamations_statut` (`statut_id`);
ALTER TABLE `statuts` ADD PRIMARY KEY (`id`);
ALTER TABLE `users` ADD PRIMARY KEY (`id`);

-- 4. AUTO-INCREMENTS
ALTER TABLE `categories` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
ALTER TABLE `commentaires` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
ALTER TABLE `gestionnaires` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
ALTER TABLE `pieces_jointes` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
ALTER TABLE `reclamations` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
ALTER TABLE `statuts` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
